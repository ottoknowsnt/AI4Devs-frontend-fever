...
Se tuvo que aclarar que los ids eran numéricos:

```
Todos los ids son enteros, ¿puedes realizar los cambios necesarios en el código para reflejar esto?
```

## Funcionalidad para actualizar la fase arrastrando el candidato
